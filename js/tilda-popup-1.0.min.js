function t_popup__trapFocus(t) {
  var t = t.querySelectorAll(
      'a, button, input:not([type="hidden"]):not(.js-form-spec-comments), select, textarea, video, iframe'
    ),
    o = t[0],
    p = t[t.length - 1];
      ...
      (((e = "Tab" === t.key || 9 === t.keyCode) || (e && t.shiftKey)) &&
        (t.shiftKey
          ? (document.activeElement.classList.contains("t-popup_show") &&
              p.focus(),
            document.activeElement === o && (p.focus(), t.preventDefault()))
          : document.activeElement === p && (o.focus(), t.preventDefault())));
  });
}
...
function t_popup__resizePopup(t) {
  ...
  !p ||
    ((e = p.querySelector(".t-popup__container")) &&
      ...
      (o = 120),
      (364 !== (p = Number(p.getAttribute("data-record-type"))) && 365 !== p) ||
        (o = 30),
      (868 !== p && 331 !== p && 358 !== p && 1013 !== p && 746 !== p) ||
        (o = 0),
    ...
    t.addEventListener("keydown", function (t) {
      13 !== t.keyCode ||
        ((t = !!(t = t.target).closest('a[href="' + e + '"]') && t) &&
          (window.isMobile || t.classList.add("t-popup__triggered-btn")));
    });
}
