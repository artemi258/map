(window.t_forms__lang = (
  ...
  t_onReady(function () {
    ...
    t &&
      ((e = t.getAttribute("data-tilda-project-lang")) &&
        (window.t_forms__lang = e),
      (r = t.getAttribute("data-tilda-root-zone")) &&
        (window.tildaForm.endpoint = "forms.tildaapi." + r)),
      t_forms__initForms();
